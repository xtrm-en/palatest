package me.xtrm.paladium.palatest.client.entity.model;
...
public class ModelGolem extends ModelBase {
    ...
    public ModelGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.ironGolemRightLeg.rotateAngleX = 1.5F * this.triangleWave(limbSwing) * limbSwingAmount;
    ...
    private float triangleWave(float swing) {
        return (Math.abs(swing % (float) 13.0 - (float) 13.0 * 0.5F) - (float) 13.0 * 0.25F) / ((float) 13.0 * 0.25F);
    }
}
